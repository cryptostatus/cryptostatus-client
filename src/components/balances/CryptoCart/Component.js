          ...
          <div>
            <div className='crypto-cart-info crypto-cart__field-wrap'>
              <div className='crypto-cart-column'>
                ...
                <span className='crypto-cart__field'>
                  <Input name='amount' step='0.000001' className='purple__theme' type='number' placeholder='amount' />
                </span>
              </div>
            </div>
            ...
            <div className='crypto-cart-info crypto-cart__field-wrap'>
              <div className='crypto-cart-column'>
                ...
                <span className='crypto-cart__field'>
                  <Input name='invested' step='0.01' className='orange__theme' type='number' placeholder='invested' />
                </span>
              </div>
            </div>
            ...
            <div className='crypto-cart-info crypto-cart__field-wrap'>
              <div className='crypto-cart-column'>
                ...
                <span className='crypto-cart__field'>
                  <Input name='profitPercent' step='0.01' min='1' max='999999' className='blue__theme' type='number' placeholder='profit percent' />
                </span>
              </div>
            </div>
          </div>
